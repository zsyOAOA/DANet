...
from datasets.DenoisingDatasets import BenchmarkTrain, BenchmarkTest, PolyuTrain
...
def main():
    # set parameters
    with open('./configs/GDANet.json', 'r') as f:
        args = json.load(f)
    ...
    datasets_list = [BenchmarkTrain(h5_file=args['SIDD_train_h5'],
                     ...
                     PolyuTrain(path_list=path_list_Poly,
                                length=1000*args['batch_size']*args['num_critic'],
                                pch_size=args['patch_size'],
                                mask=False)]
